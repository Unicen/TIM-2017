%%% PR�CTICO N�3 - TALLER DE IM�GENES M�DICAS - FACULTAD DE CIENCIAS
%%% EXACTAS - UNCPBA.
...
%% Ejercicio 1.a)
% Obtener el histograma de la imagen de resonancia magn�tica de modalidad T1.
% Qu� dificultad se encuentra al visualizar el histograma? 
[~,Ft1] = mode(t1(:));
...
% magn�tica, aplicando una m�scara a cada una de ellas. 
% Discutir las caracter�sticas de cada uno y comparar brevemente.

% Armo una m�scara s�lo de la parte que nos interesa (el cerebro)
...
%% Ejercicio 1.c)
% Obtener las intensidades m�xima, m�nima y promedio de cada imagen. 
% Obtener la moda del histograma. �Coinciden la moda y la intensidad 
% m�xima? �Por qu�? Comparar los valores de moda obtenidos para cada 
% imagen.
